...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.display.setStyleSheet('*{background: #fff; font-size:30px; color: #000;}')
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: #fff; font-weight: 900'
            )
        ...
        self.add_btn(
            QPushButton('<-'), 3, 4, 1, 1, lambda: self.display.setText(
                self.display.text()[:-1]
            ), 'background-color: #13823a; font-weight: 900; color: #fff'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual, 'font-weight: 900; background-color: #126691; color: #fff'
        )
